...
export default async function ExploreCommunitiesPage({ searchParams }: ExplorePageProps) {
  ...
  return (
    <ScrollRevealWrapper>
      <div className="min-h-screen bg-[rgb(var(--color-bg))] text-[rgb(var(--color-fg))] selection:bg-[rgb(var(--color-accent)/0.2)] transition-colors duration-500">
        <div className="mx-auto max-w-7xl px-6 py-16 sm:py-24 space-y-20">
          ...
          <section className="relative text-center max-w-4xl mx-auto space-y-6">
            <h1 className="reveal text-5xl sm:text-7xl font-black tracking-tight leading-[1.1]">
              Discover 
            ...
            <p className="reveal delay-100 text-lg sm:text-xl text-[rgb(var(--color-fg-muted))] max-w-2xl mx-auto leading-relaxed font-medium">
              The best way to learn is together. Find your circle, share knowledge, and grow faster.
            </p>

            {/* SEARCH BAR */}
            <div className="reveal delay-200 max-w-2xl mx-auto pt-8">
          ...
          <section className="space-y-8">
            <div className="reveal flex flex-col sm:flex-row sm:items-end justify-between gap-4 border-b border-[rgb(var(--color-border))] pb-6">
            ...
            {communities.length === 0 ? (
              <div className="reveal py-32 text-center rounded-3xl border-2 border-dashed border-[rgb(var(--color-border))] bg-[rgb(var(--color-bg-soft)/0.5)]">
              ...
              <div className="reveal delay-100 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
            ...
            {!searchTerm && hasMore && (
              <div className="reveal flex justify-center pt-12">
                <Link
                  href={`?page=${page + 1}`}
          ...
          {/* CTA SECTIONS */}
          <section className="reveal delay-200 relative overflow-hidden rounded-[2.5rem] bg-[rgb(var(--color-fg))] p-1 text-center">
