...
import ScrollRevealWrapper from '@/app/(frontend)/components/ScrollRevealWrapper';
      ...
      <div className="min-h-screen bg-[rgb(var(--color-bg))] text-[rgb(var(--color-fg))] transition-colors duration-500">
        <div className="max-w-6xl mx-auto px-6 py-12 lg:py-20 space-y-16 pb-32">
          ...
          <header className="flex flex-col items-center text-center space-y-4">
            <h1 className="reveal text-5xl md:text-6xl lg:text-7xl font-black tracking-tight leading-none">
            ...
            <p className="reveal delay-100 text-[rgb(var(--color-fg-muted))] max-w-xl text-lg font-medium">
          ...
          <main>
            {userCommunities.length === 0 ? (
              <div className="reveal delay-300 text-center py-32 rounded-[3rem] border-2 border-dashed border-[rgb(var(--color-border)/0.5)] bg-[rgb(var(--color-bg-soft)/0.1)]">
              ...
              <div className="reveal delay-300 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
