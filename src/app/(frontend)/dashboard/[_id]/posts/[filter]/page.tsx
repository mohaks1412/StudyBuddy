    ...
    <ScrollRevealWrapper>
      <div className="space-y-10 pb-20">
        ...
        <header className="space-y-4">
          <nav className="reveal flex items-center gap-2 text-[10px] font-black uppercase tracking-[0.2em] text-[rgb(var(--color-fg-subtle))] opacity-60">
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
            <div className="space-y-1">
              <h1 className="reveal delay-100 text-4xl md:text-5xl font-black tracking-tighter leading-none text-[rgb(var(--color-fg))]">
        ...
        <main className="reveal delay-200 relative">
          ...
          <div className="lg:pl-8">
            <PostList
              ...
              title={filterType === "all" ? "User Activity" : `${filterType.replace("-", " ")}`}
            />
          </div>
        </main>
      </div>
