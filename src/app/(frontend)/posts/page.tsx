        ...
        <div className="max-w-5xl mx-auto px-6 py-12 lg:py-20 pb-40 space-y-16">
          ...
          <header className="flex flex-col md:flex-row md:items-end justify-between gap-8 border-b border-[rgb(var(--color-border)/0.5)] pb-12">
            <div className="space-y-4">
              {/* Individual reveal for Title */}
              <h1 className="reveal text-5xl md:text-7xl font-black tracking-tighter leading-none">
              ...
              {/* Individual reveal for Paragraph */}
              <p className="reveal delay-100 text-sm font-medium text-[rgb(var(--color-fg-muted))] max-w-md leading-relaxed">
                {isUnauthorized 
            ...
            {/* Individual reveal for Button area */}
            <div className="reveal delay-200 flex flex-col sm:flex-row gap-3">
              {!isUnauthorized ? (
                <Link 
                  href="/posts/new"
          ...
          {/* MAIN CONTENT - Reveals separately from header */}
          <main className="reveal delay-300">
            {showPosts ? (
